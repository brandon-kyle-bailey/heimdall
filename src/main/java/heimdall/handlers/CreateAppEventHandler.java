...
// import heimdall.dtos.AppEntity;
...
// LoggerPort.debug("CreateAppEventHandler.handle invoked:
// %s".formatted(event));
// try {
// event.put("id", 0);
// AppEntity app = AppDtoMapper.interfaceToDomain(event);
// List<AppEntity> foundApps = repository.findByName(app.getName());
