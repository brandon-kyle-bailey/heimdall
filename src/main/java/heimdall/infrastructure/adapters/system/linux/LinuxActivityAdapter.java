package heimdall.infrastructure.adapters.system.linux;
...
public class LinuxActivityAdapter implements IActivityTracker {
  ...
  public LinuxActivityAdapter(LoggingPort logManager, EventbusAdapter eventbus, WebsocketAdapter websocket) {
